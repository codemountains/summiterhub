    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dest_user_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='friend_request_dest_user_id', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dest_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friend_dest_user_id', to=settings.AUTH_USER_MODEL)),
                ('friend_request_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friend_friend_request_id', to='users.friendrequest')),
                ('src_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friend_src_user_id', to=settings.AUTH_USER_MODEL)),
            ],
            options={
