    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mountain_second', models.CharField(blank=True, max_length=50, null=True)),
                ('mountain_third', models.CharField(blank=True, max_length=50, null=True)),
                ('mountain_fourth', models.CharField(blank=True, max_length=50, null=True)),
                ('mountain_fifth', models.CharField(blank=True, max_length=50, null=True)),
                ('is_submitted', models.BooleanField(default=False)),
                ('submitted_date', models.DateField(blank=True, null=True)),
                ('entering_date', models.DateField()),
                ('descending_date', models.DateField()),
                ('affiliate_group_name', models.CharField(blank=True, max_length=100, null=True)),
                ('affiliate_group_phone', models.CharField(blank=True, max_length=13, null=True)),
